            ...
            <div class="card shadow-sm border-0">
                <div class="card-image text-center">
                          ...
                          <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">WARNING! WARNING!! WARNING!!!</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                              </div>
                              <div class="modal-body text-danger">
                               Are You 100% sure you want to log out??
                              </div>
                              <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                <a href="login.php" class="btn btn-primary">Yes, Log out</a>
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <form action="process.php" method="POST" enctype="multipart/form-data">
                            ...
                            ?>
                                <img src="<?php echo 'uploads/' . $thisUser['profile_pic'] ?>" alt="" style="height: 200px; width: 200px;" class="rounded-circle border border-danger">
                        <label for="img" class="text-color" style="cursor: pointer;">
                            <b>Change file</b>
